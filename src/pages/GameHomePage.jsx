...
export default function GameHomePage() {
  ...
  const start = () => {
    ...
    if (!game.playable) {
      setMessage(
        'This banner is complete; gameplay is only enabled for Blade Master and Nutcraft.'
      )
      return
    }
    ...
    if (state.tokens < game.cost) {
      setMessage(
        `Not Enough Tokens. You need ${game.cost} Tokens to play. Your Balance: ${state.tokens} Tokens.`
      )
      return
    }
  ...
  const closeGuide = () => {
    // Required guide cannot be skipped.
      ...
      <div className={styles.shell}>
        ...
        <section className={styles.features}>
          <div>
            <b>Game Coins</b>
            <span>
              Rewards flow into one centralized balance.
            </span>
          </div>
          ...
          <div>
            <b>Revive</b>
            <span>
              The two playable games support a working revive
              flow.
            </span>
          </div>
          ...
          <div>
            <b>Responsive</b>
            <span>
              Built for touch, mouse, tablet, and desktop.
            </span>
          </div>
        </section>
